...
<script>
const endpoint='/v0/management/plugins/provider-rate-limiter/settings';const persistEndpoint='/v0/management/plugins/provider-rate-limiter/config';const accountsEndpoint='/v0/management/auth-files';const status=document.getElementById('status');const state={accounts:[],providers:{},auths:{},defaultRPM:0};
